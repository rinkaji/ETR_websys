            ...
            <table class="table table-bordered table-hover align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $supply->reorder_threshold }}</td>
                        <td>
                            <a href="{{ route('admin.edit', $supply->id) }}" class="btn btn-sm btn-warning">Edit</a>
                            <form action="{{ route('admin.destroy', $supply->id) }}" method="POST"
                                style="display:inline;">
                                @csrf @method('DELETE')
                                <button type="submit" class="btn btn-sm btn-danger"
                                    onclick="return confirm('Delete this item?')">Delete</button>
                            </form>
                            <a href="{{ route('admin.stockCard', $supply->item) }}" class="btn btn-sm btn-info">View</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
